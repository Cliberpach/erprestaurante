import{s as o}from"./index-dd82ac63.js";function p(){return window.innerWidth>=992}window.isDesktop=p;const u=window.matchMedia("(min-width: 992px)");let m=u.matches,d=[],l=null,v=null;const i={inputQuantity:document.querySelector("#cantidad"),inputProduct:document.querySelector("#producto"),inputPurchasePrice:document.querySelector("#purchase_price"),inputSalePrice:document.querySelector("#sale_price"),inputQuantity:document.querySelector("#cantidad"),inputStock:document.querySelector("#item_stock"),inputObservation:document.querySelector("#observation_item"),imgQrPayment:document.querySelector("#img-qr-payment"),inputVoucher:document.querySelector("#voucher")};function y(t){m=t}function D(t){d=t}function b(){return d}function r(t){l=t}function f(){return l}function I(t){v=t}function E(){return v}window.getLstDetail=b;window.setDtDetail=r;window.getDtDetail=f;window.setLstDetail=D;window.getCustomerSelect=E;function g(t){t.matches!==m&&(y(t.matches),w(d))}function w(t){const e=document.getElementById("tbl_order_detail"),a=document.getElementById("cards_dishes");!e||!a||(isDesktop()?(e.classList.remove("d-none"),a.classList.add("d-none"),clearTable("tbl_order_detail"),r(destroyDataTable(l)),paintTblDetail(t),r(loadDataTableSimple("tbl_order_detail"))):(e.classList.add("d-none"),a.classList.remove("d-none"),clearTable("tbl_order_detail"),r(destroyDataTable(l)),paintCardsDetail(t)))}function P(){u.addEventListener("change",t=>{g(t)})}const c={validateProductStock:({warehouseId:t,productId:e,quantity:a,orderId:s=null})=>o("tenant.utils.validatedProductStock",{warehouse_id:t,product_id:e,quantity:a,order_id:s}),validateDishStock:({programmingId:t,dishId:e,quantity:a,orderId:s=null})=>o("tenant.utils.validatedDishStock",{programming_id:t,dish_id:e,quantity:a,order_id:s}),getBankAccountPayment:t=>o("tenant.utils.getBackAccountPayment",{payment_method:t}),validationPassword:o("tenant.utils.validationPassword")};async function h({warehouseId:t,productId:e,quantity:a,orderId:s=null}){try{const n=await axios.get(c.validateProductStock({warehouseId:t,productId:e,quantity:a,orderId:s}));return n.data.success?n:(toastr.error(n.data.message,"ERROR EN EL SERVIDOR"),null)}catch(n){return toastr.error(n,"ERROR EN LA PETICIÓN VALIDAR STOCK PRODUCTO"),null}}async function S({programmingId:t,dishId:e,quantity:a,orderId:s=null}){try{const n=await axios.get(c.validateDishStock({programmingId:t,dishId:e,quantity:a,orderId:s}));return n.data.success?n:(toastr.error(n.data.message,"ERROR EN EL SERVIDOR"),null)}catch(n){return toastr.error(n,"ERROR EN LA PETICIÓN VALIDAR STOCK PLATO"),null}}async function O(t){try{const e=await axios.get(c.getBankAccountPayment(t));return e.data.success?(toastr.info(e.data.message,"OPERACIÓN COMPLETADA"),e):(toastr.error(e.data.message,"ERROR EN EL SERVIDOR"),null)}catch(e){return toastr.error(e,"ERROR EN LA PETICIÓN OBTENER CUENTA BANCARIA ACTIVA"),null}}window.validateProductStock=h;window.validateDishStock=S;function R(t){const e=document.getElementById("cards_dishes");e.innerHTML="",t.forEach(a=>{e.innerHTML+=`
