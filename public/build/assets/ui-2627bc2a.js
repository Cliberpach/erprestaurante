import{l as p}from"./main-d792cefb.js";import{s as l}from"./index-dd82ac63.js";function v(){return window.innerWidth>=992}window.isDesktop=v;window.loadSimpleSelect=p;const u=window.matchMedia("(min-width: 992px)");let m=u.matches,d=[],r=null;const i={inputQuantity:document.querySelector("#cantidad"),inputProduct:document.querySelector("#producto"),inputPurchasePrice:document.querySelector("#purchase_price"),inputSalePrice:document.querySelector("#sale_price"),inputQuantity:document.querySelector("#cantidad"),inputStock:document.querySelector("#item_stock"),inputObservation:document.querySelector("#observation_item"),imgQrPayment:document.querySelector("#img-qr-payment"),lgQrPayment:document.querySelector(".lg-item"),inputVoucher:document.querySelector("#voucher")};function y(t){m=t}function D(t){d=t}function E(){return d}function o(t){r=t}function f(){return r}window.getLstDetail=E;window.setDtDetail=o;window.getDtDetail=f;window.setLstDetail=D;function g(t){t.matches!==m&&(y(t.matches),w(d))}function w(t){const e=document.getElementById("tbl_order_detail"),a=document.getElementById("cards_dishes");!e||!a||(isDesktop()?(e.classList.remove("d-none"),a.classList.add("d-none"),clearTable("tbl_order_detail"),o(destroyDataTable(r)),paintTblDetail(t),o(loadDataTableSimple("tbl_order_detail"))):(e.classList.add("d-none"),a.classList.remove("d-none"),clearTable("tbl_order_detail"),o(destroyDataTable(r)),paintCardsDetail(t)))}function P(){u.addEventListener("change",t=>{g(t)})}const c={validateProductStock:({warehouseId:t,productId:e,quantity:a,orderId:s=null})=>l("tenant.utils.validatedProductStock",{warehouse_id:t,product_id:e,quantity:a,order_id:s}),validateDishStock:({programmingId:t,dishId:e,quantity:a,orderId:s=null})=>l("tenant.utils.validatedDishStock",{programming_id:t,dish_id:e,quantity:a,order_id:s}),getBankAccountPayment:t=>l("tenant.utils.getBackAccountPayment",{payment_method:t}),validationPassword:l("tenant.utils.validationPassword")};async function b({warehouseId:t,productId:e,quantity:a,orderId:s=null}){try{const n=await axios.get(c.validateProductStock({warehouseId:t,productId:e,quantity:a,orderId:s}));return n.data.success?n:(toastr.error(n.data.message,"ERROR EN EL SERVIDOR"),null)}catch(n){return toastr.error(n,"ERROR EN LA PETICIÓN VALIDAR STOCK PRODUCTO"),null}}async function S({programmingId:t,dishId:e,quantity:a,orderId:s=null}){try{const n=await axios.get(c.validateDishStock({programmingId:t,dishId:e,quantity:a,orderId:s}));return n.data.success?n:(toastr.error(n.data.message,"ERROR EN EL SERVIDOR"),null)}catch(n){return toastr.error(n,"ERROR EN LA PETICIÓN VALIDAR STOCK PLATO"),null}}async function I(t){try{const e=await axios.get(c.getBankAccountPayment(t));return e.data.success?(toastr.info(e.data.message,"OPERACIÓN COMPLETADA"),e):(toastr.error(e.data.message,"ERROR EN EL SERVIDOR"),null)}catch(e){return toastr.error(e,"ERROR EN LA PETICIÓN OBTENER CUENTA BANCARIA ACTIVA"),null}}window.validateProductStock=b;window.validateDishStock=S;function h(t){const e=document.getElementById("cards_dishes");e.innerHTML="",t.forEach((a,s)=>{e.innerHTML+=`
        ...
        `})}function O(t){i.inputProduct.value="",i.inputSalePrice.value="",i.inputQuantity.value="",i.inputStock.value="",i.inputObservation.value="",t.id=null,t.name=null,t.type_name=null,t.quantity=null,t.type_item=null,t.total=null,clearDishSelected(),clearProductSelected()}window.paintCardsDetail=h;export{S as a,P as b,O as c,r as d,i as e,D as f,I as g,v as i,d as l,h as p,o as s,b as v};
