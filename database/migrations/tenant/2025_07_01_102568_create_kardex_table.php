...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('kardex', function (Blueprint $table) {
            ...
            $table->string('sale_code', 20)->nullable();
            ...
            $table->unsignedBigInteger('note_credit_id')->nullable();
            $table->foreign('note_credit_id')->references('id')->on('credit_notes');
            $table->string('note_credit_code', 20)->nullable();
