<form action="" method="post" id="formRegistrarProveedor">
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-2">
            ...
            <select required name="tipo_documento" required class="select2_form_mdl_supplier form-select"
                id="tipo_documento" data-placeholder="Seleccionar" onchange="changeTipoDoc()">
                <option></option>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-2">
            ...
            <div class="input-group mb-3">
                ...
                <input required readonly id="nro_documento" name="nro_documento" type="text" class="form-control"
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-2">
            ...
            <div class="input-group">
                ...
                <input required id="nombre" name="nombre" type="text" class="form-control input-fill"
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-2">
            ...
            <div class="input-group mb-3">
                ...
                <input id="direccion" name="direccion" type="text" class="form-control input-fill"
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-2">
            ...
            <div class="input-group mb-3">
                ...
                <input id="telefono" name="telefono" type="text" class="form-control input-fill"
                    placeholder="Dirección" aria-label="Username" aria-describedby="basic-addon1">
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-2">
            ...
            <div class="input-group mb-3">
                ...
                <input id="correo" name="correo" type="email" class="form-control input-fill"
                    placeholder="Dirección" aria-label="Username" aria-describedby="basic-addon1">
            </div>
