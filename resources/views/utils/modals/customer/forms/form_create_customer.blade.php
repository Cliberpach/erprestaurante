            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 mb-2">
                    ...
                    <div class="input-group">
                        <input maxlength="8" id="nro_document" name="nro_document" required type="text" class="form-control inputEntero" placeholder="N° DOCUMENTO" aria-label="Recipient's username" aria-describedby="button-addon2">
                        <button
