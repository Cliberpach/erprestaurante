    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @include('utils.modals.consumables_categories.forms.form_create')
...
<script>
    let paramsMCCategory = {
        categorySelect: null
    }

    function loadMdlConsumableCategory(config) {
        paramsMCCategory = config;
        eventsMdlCreate();
    }

    function openMdlCCategory() {
            ...
            if (result.isConfirmed) {
                ...
                try {
                    ...
                    if (response.status === 422) {
                        if ('errors' in res) {
                            paintValidationErrors(res.errors, '_mdlccategory_error');
                        }
                        Swal.close();
                        return;
                    }
                    ...
                    if (res.success) {
                        setNewConsumableCategory(res.item);
    ...
    function setNewConsumableCategory(_item) {
        paramsMCCategory.categorySelect.clear();
        ...
        paramsMCCategory.categorySelect.addOption(item);
        paramsMCCategory.categorySelect.setValue(item.id);
    }
</script>
