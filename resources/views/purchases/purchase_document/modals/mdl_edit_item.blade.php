...
<script>
    ...
    function eventsMdlEditItem() {
        document.addEventListener('click', (e) => {
            ...
            const targetEdit = e.target.closest('.btnEditItem');
            if (targetEdit) {
                toastr.clear();
                const producto_id = targetEdit.getAttribute('data-producto-id');
            ...
            const targetDelete = e.target.closest('.btnDeleteItem');
            if (targetDelete) {
                toastr.clear();

                const producto_id = targetDelete.getAttribute('data-producto-id');
