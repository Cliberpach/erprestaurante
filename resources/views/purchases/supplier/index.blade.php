    ...
    <div class="card">
        ...
        <div class="card-header d-flex justify-content-between flex-row">
            ...
            <div class="input-group-append">
                <button onclick="goToSupplierCreate()" type="button" data-bs-whatever="Nueva caja"
...
@section('js')
    <script>
        ...
        function loadDataTableSuppliers() {
            const urlGetProveedores = '{{ route('tenant.compras.proveedores.getSuppliers') }}';
            ...
            dtSuppliers = new DataTable('#tbl_list_supplier', {
                ...
                columns: [{
                    ...
                    {
                        data: 'type_identity_document_name',
                        name: 'type_identity_document_name'
                    },
                    {
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            const baseUrlEdit =
                                `{{ route('tenant.compras.proveedores.edit', ['id' => ':id']) }}`;
        ...
        function goToSupplierCreate() {
            window.location.href = @json(route('tenant.compras.proveedores.create'));
        }
                ...
                if (result.isConfirmed) {
                    ...
                    try {
                        let urlDeleteProveedor =
                            `{{ route('tenant.compras.proveedores.destroy', ['id' => ':id']) }}`;
