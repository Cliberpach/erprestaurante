...
@section('js')
    <script>
        ...
        function events() {
            ...
            document.addEventListener('click', (e) => {
                if (e.target.closest('.btnVolver')) {
                    const rutaIndex = '{{ route('tenant.compras.proveedores.index') }}';
        ...
        function loadSelectsSuppliers() {
            const typeDocumentSelect = document.getElementById('tipo_documento');
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    try {
                        ...
                        let urlUpdateProveedor =
                            `{{ route('tenant.compras.proveedores.update', ['id' => ':id']) }}`;
                        ...
                        if (res.success) {
                            const proveedor_index = @json(route('tenant.compras.proveedores.index'));
