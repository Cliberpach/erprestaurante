<form action="" method="post" id="formActualizarProveedor">
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-2">
            ...
            <select required name="tipo_documento" required class="select2_form form-select" id="tipo_documento"
                data-placeholder="Seleccionar" onchange="changeTipoDoc()">
                <option></option>
                @foreach ($type_identity_documents as $tipo_documento)
                    <option @if ($tipo_documento->id === $supplier->type_identity_document_id) selected @endif value="{{ $tipo_documento->id }}">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-2">
            ...
            <div class="input-group mb-3">
                <button @if ($supplier->type_identity_document_id !== 1 && $supplier->type_identity_document_id !== 3) disabled @endif id="btn_consultar_documento"
                    class="btn btn-primary" type="button" id="button-addon1">
                    <i class="fa-solid fa-magnifying-glass" style="color:white;"></i>
                </button>
                <input value="{{ $supplier->document_number }}" required
                    @if ($supplier->type_identity_document_id !== 1 && $supplier->type_identity_document_id !== 3) readonly @endif id="nro_documento" name="nro_documento"
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-2">
            ...
            <div class="input-group">
                ...
                <input value="{{ $supplier->name }}" required id="nombre" name="nombre" type="text"
                    class="form-control input-fill" placeholder="Nombre" aria-label="Username"
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-2">
            ...
            <div class="input-group mb-3">
                ...
                <input value="{{ $supplier->address }}" id="direccion" name="direccion" type="text"
                    class="form-control input-fill" placeholder="Dirección" aria-label="Username"
                    aria-describedby="basic-addon1">
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-2">
            ...
            <div class="input-group mb-3">
                ...
                <input value="{{ $supplier->phone }}" id="telefono" name="telefono" type="text"
                    class="form-control input-fill" placeholder="Dirección" aria-label="Username"
                    aria-describedby="basic-addon1">
            </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-2">
            ...
            <div class="input-group mb-3">
                ...
                <input value="{{ $supplier->email }}" id="correo" name="correo" type="email"
                    class="form-control input-fill" placeholder="Dirección" aria-label="Username"
                    aria-describedby="basic-addon1">
            </div>
