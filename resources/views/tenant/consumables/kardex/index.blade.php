...
@section('content')
    <div class="card">
        ...
        <div class="card-header d-flex justify-content-between flex-row">
            <h4 class="card-title">KARDEX INSUMOS</h4>
        ...
        <div class="card-body">
            <div class="row align-items-end mb-3">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <label for="consumable_id" class="fw-bold text-primary">
                        <i class="fas fa-box-open me-1"></i> INSUMO
                    </label>
                    <select data-placeholder="Seleccionar" id="consumable_id" class="form-select">
                        <option value=""></option>
                    </select>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="table-responsive">
                        @include('tenant.consumables.kardex.tables.tbl_list_kardex')
                    </div>
                </div>
            </div>
...
@section('js')
    <script>
        ...
        function loadTomSelect() {
            window.consumableSelect = new TomSelect('#consumable_id', {
                valueField: 'id',
                labelField: 'text',
                ...
                load: async (query, callback) => {
                    ...
                    try {
                        ...
                        const urlSearch = 'tenant.utils.searchConsumable';

                        const url = route(urlSearch, {
                            q: query,
                            warehouse_id: 1
                        });
        ...
        function loadDtKardex() {
            const urlGetKardex = '{{ route('tenant.insumos.kardex.getKardex') }}';
            ...
            dtKardex = new DataTable('#tbl_list_kardex', {
                ...
                ajax: {
                    ...
                    data: function(d) {
                        d.warehouse_id = 1;
                        d.consumable_id = document.querySelector('#consumable_id').value;
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            ...
                            if (parseFloat(data) > 0) {
                                return `<span class="kardex-entrada">${value}</span>`;
                            }
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            ...
                            if (parseFloat(data) > 0) {
                                return `<span class="kardex-salida">${value}</span>`;
                            }
                    ...
                    },
                    {
                        ...
                        render: function(data) {
                            const value = parseFloat(data).toFixed(2);
                            return `<span class="kardex-saldo">${value}</span>`;
                        }
                    },
                    {
        ...
        function downloadExcel() {
            ...
            const params = {
                warehouse_id: 1,
                consumable_id: document.querySelector('#consumable_id').value,
        ...
        function downloadPdf() {
            ...
            const url = @json(route('tenant.insumos.kardex.pdf'));
