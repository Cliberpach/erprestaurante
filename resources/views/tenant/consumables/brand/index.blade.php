...
@section('content')
    @include('tenant.consumables.brand.modals.mdl_create')
    @include('tenant.consumables.brand.modals.mdl_edit')
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
            <h4 class="card-title mb-md-0 mb-2">LISTA DE MARCAS INSUMOS</h4>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col">
                    @include('tenant.consumables.brand.tables.tbl_list_categories')
                </div>
            </div>
        </div>
    </div>
...
@section('js')
    <script>
        ...
        function loadDtCategories() {
            const url = '{{ route('tenant.insumos.marcas.getAll') }}';
        ...
        function deleteCategory(id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    try {
                        let url = route('tenant.insumos.marcas.destroy', {
                            id
                        });
