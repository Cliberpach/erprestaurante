...
<body>
    ...
    <div class="card">
        ...
        <div class="logo-mark">
            <div class="logo-icon">
                <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M4 26 C4 26 6 10 16 6 C26 10 28 26 28 26" stroke="#c8a050" stroke-width="1.5"
                        stroke-linecap="round" />
                    <path d="M10 26 C10 26 11 16 16 13 C21 16 22 26 22 26" stroke="#c8a050" stroke-width="1.2"
                        stroke-linecap="round" opacity=".6" />
                    <line x1="4" y1="26" x2="28" y2="26" stroke="#c8a050"
                        stroke-width="1.5" stroke-linecap="round" />
                    <circle cx="16" cy="6" r="1.5" fill="#e8c87a" />
                </svg>
            </div>
            <div class="logo-text">Comanda<span>Pro</span></div>
        </div>
        ...
        <div class="info-box">
            ...
            <div class="info-row">
                ...
                <div>
                    ...
                    <div class="info-value">+51 999 999 999 &nbsp;·&nbsp; soporte@comandapro.pe</div>
                </div>
            </div>
        </div>
        ...
        <!-- CTA -->
        <div class="cta">
            <a href="mailto:soporte@comandapro.pe" class="btn-primary">
        ...
        <div class="footer-note">
            ¿Necesitas ayuda urgente? Escríbenos a <a href="mailto:soporte@comandapro.pe">soporte@comandapro.pe</a>
        </div>
