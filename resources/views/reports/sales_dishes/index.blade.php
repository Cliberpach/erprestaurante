        ...
        <div class="card-header">
            ...
            <div class="row align-items-center mb-3">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <h6 class="card-title mb-0">Reporte Venta Plato</h6>
                </div>
            </div>
...
@section('js')
    <script>
        ...
        function loadtDtQuery() {
            const url = '{{ route('tenant.reportes.ventas_platos.getAll') }}';
        ...
        function downloadExcel() {
            ...
            const url = @json(route('tenant.reportes.ventas_platos.excel'));
