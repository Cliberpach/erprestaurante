...
<head>
    ...
    <title>Reporte Venta Plato</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <table class="info-table-custom">
            ...
            <tr>
                <td class="label"><strong>TIPO PLATO:</strong></td>
                <td>{{ $filters->get('type_dish_name') }}</td>
            </tr>
            <tr>
                <td class="label"><strong>PLATO:</strong></td>
                <td>{{ $filters->get('dish_name') }}</td>
            </tr>
            <tr>
