                    ...
                    <div class="row align-items-center g-3">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="d-flex align-items-center info-box">
                                <i class="fa-solid fa-clipboard-list text-primary fs-5 me-2"></i>
                                <div>
                                    <small class="text-muted d-block">Programación</small>
                                    <span class="fw-semibold" id="info_programming">
                                        {{ $programming->programming_code }}
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="d-flex align-items-center info-box">
                                <i class="fa-solid fa-cash-register text-primary fs-5 me-2"></i>
                                <div>
                                    <small class="text-muted d-block">Caja Abierta</small>
                                    <span class="fw-semibold" id="info_caja">
                                        {{ $programming->petty_cash_name }}
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="d-flex align-items-center info-box">
                                <i class="fa-solid fa-arrow-right-arrow-left text-primary fs-5 me-2"></i>
                                <div>
                                    <small class="text-muted d-block">Movimiento Caja</small>
                                    <span class="fw-semibold" id="info_petty_cash_book">
                                        {{ $programming->petty_cash_book_code }}
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="d-flex align-items-center info-box">
                                <i class="fa-solid fa-user text-primary fs-5 me-2"></i>
                                <div>
                                    <small class="text-muted d-block">Cajero</small>
                                    <span class="fw-semibold" id="info_cajero">
                                        {{ $programming->creator_user_name }}
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="d-flex align-items-center info-box">
                                ...
                                <div>
                                    ...
                                    <span class="fw-semibold" id="info_fecha_apertura">
                                        {{ $programming->initial_date }}
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="d-flex align-items-center info-box">
                                ...
                                <div>
                                    ...
                                    <span class="fw-semibold" id="info_turno">
                                        {{ $programming->shift_name }}
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input id="cantidad" type="text"
                                    class="form-control inputEnteroPositivo input-fill" placeholder="Cantidad">
                            </div>
                        </div>
