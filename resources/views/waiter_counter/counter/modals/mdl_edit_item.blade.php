    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                @include('supply.programming.forms.form_edit_item')
...
<script>
    ...
    function setProducto(producto_id) {
        ...
        document.querySelector('#item_nombre_edit').textContent = producto_find.product_name;
        document.querySelector('#item_tipo_plato_edit').textContent = producto_find.type_dish_name;
        document.querySelector('#item_precio_compra_edit').textContent = formatSoles(producto_find.purchase_price);
        document.querySelector('#item_precio_venta_edit').textContent = formatSoles(producto_find.sale_price);
