    ...
    <script>
        ...
        function events() {
            document.addEventListener('click', function(e) {
                ...
                if (e.target.closest('.btn-volver')) {
                    window.location.href = @json(route('tenant.ventas.metodos_pago.index'));
                }
        ...
        function agregarCuentasPrevias() {
            ...
            cuentas_asignadas.forEach((ca) => {
                const item = {
                    id: ca.bank_account_id,
                    active: ca.is_active == 1 ? true : false
                };
        ...
        function asignarCuentas() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    const urlAsignarCuentas = @json(route('tenant.ventas.metodos_pago.assignAccountsStore'));
