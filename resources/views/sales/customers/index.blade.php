...
@section('js')
    <script>
        ...
        function loadDtCustomers() {
            const urlGetClientes = '{{ route('tenant.ventas.clientes.getAll') }}';
                ...
                columns: [{
                    ...
                    // },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            const baseUrlEdit =
                                `{{ route('tenant.ventas.clientes.edit', ['id' => ':id']) }}`;
                            ...
                            </button><ul class="dropdown-menu dropdown-menu-end shadow-sm">`;
        ...
        function goToCrearCliente() {
            window.location.href = @json(route('tenant.ventas.clientes.create'));
        }
        ...
        function eliminarCliente(id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    try {
                        let url = `{{ route('tenant.ventas.clientes.destroy', ['id' => ':id']) }}`;
                        url = url.replace(':id', id);

                        const res = await axios.delete(route('tenant.ventas.clientes.destroy', id));
