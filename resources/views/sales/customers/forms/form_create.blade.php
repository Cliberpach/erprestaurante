<form action="" id="formRegistrarCliente" method="post">
    <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-2">
                ...
                <select name="department" class="form-select select2_cliente" id="department" data-placeholder="Seleccionar" >
                    <option></option>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 mb-2">
                ...
                <select name="province" class="form-select select2_cliente" id="province" data-placeholder="Seleccionar" >
                    <option></option>
