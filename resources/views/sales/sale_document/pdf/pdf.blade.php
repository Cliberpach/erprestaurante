...
<head>
    ...
    <title>{{ $sale->serie . '-' . $sale->correlative }}</title>
    ...
    <div class="cabecera">
        ...
        <div class="comprobante">
            <div class="numero-documento">
                <p class="text-uppercase m-0 p-0">{{ $sale->type_sale_name }}</p>
                <p class="text-uppercase m-0 p-0">{{ $sale->serie . '-' . $sale->correlative }}</p>
            </div>
        </div>
    </div><br>
