    ...
    function eventsMdlEditItem() {
        document.addEventListener('click', (e) => {
            ...
            if (btnEdit) {
                ...
                const productId = btnEdit.getAttribute('data-producto-id');
            ...
            if (btnDelete) {
                ...
                const productId = btnDelete.getAttribute('data-producto-id');
                ...
                const res_delete_item = deleteItem(productId);
