    ...
    <div class="card">
        ...
        <div class="card-header d-flex justify-content-between flex-row">
            ...
            <div class="input-group-append">
                <button onclick="goToNoteReleaseCreate()" type="button" data-bs-whatever="Nueva caja"
...
@section('js')
    <script>
        ...
        function startDataTableNoteRelease() {
            const urlGetNoteIncome = '{{ route('tenant.inventario.nota_salida.getNotesRelease') }}';
        ...
        function goToNoteReleaseCreate() {
            const route = @json(route('tenant.inventario.nota_salida.create'));
