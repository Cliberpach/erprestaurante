<form id="formPagar" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <input type="date" name="fecha" id="fecha" class="form-control input-fill" value="<?= date('Y-m-d') ?>"
                required>
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <input type="text" maxlength="20" id="nro_operacion" name="nro_operacion" class="form-control input-fill">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <textarea name="observacion" id="observacion" cols="30" rows="3" class="form-control input-fill"></textarea>
