<table class="table-hover table" id="tbl_landlord_companies">
    <thead class="table-light">
        <tr>
            <th data-priority="1" class="minw-100px">Hostname</th>
            <th data-priority="3" class="minw-100px">Razón Social</th>
