<form action="" method="post" id="formBillingNumeration">
    ...
    <div class="row">
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 mb-3">
            ...
            <select required name="billing_type_document" required class="select2_form_numeration form-select"
                id="billing_type_document" data-placeholder="Seleccionar" onchange="setBillingType(this.value)">
                <option></option>
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 mb-3">
            ...
            <input required maxlength="4" type="text" name="serie" id="serie" class="form-control input-fill"
        ...
        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 mb-3">
            ...
            <input required value="1" maxlength="8" type="text" name="start_number" id="start_number"
                class="input-fill form-control inputEnteroPositivo">
