...
import { destroySelectGlobal, loadSelectGlobal } from "./tomselect";
...
export function paintLstPays(lstPays) {
    ...
    destroySelectGlobal('tomselect_pay');
    tbody.innerHTML = '';
    ...
    lstPays.forEach((pay, index) => {
        ...
        let new_pay = `<tr>
                            <td>
                                <select  name="" id="" class="form-control method_pay tomselect_pay" data-index="${index}" data-placeholder="Seleccionar">
                                <option></option>
                        `;
