...
class ConsumableUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'name' => [
                ...
                'min:3',
                'max:160',
                Rule::unique('consumables', 'name')->ignore($this->route('id'))->where('status', 'ACTIVO'),
            ],
            'description' => 'nullable|string|max:200',
            'sale_price' => 'required|numeric|gt:0|max:999999',
            'purchase_price' => 'required|numeric|gt:0|max:999999',
    ...
    public function messages(): array
    {
        return [
            ...
            'sale_price.max' => 'El precio de venta no debe exceder 999999.',
            ...
            'purchase_price.gt' => 'El precio de compra debe ser mayor a 0.',
            'purchase_price.max' => 'El precio de compra no debe exceder 999999.',
