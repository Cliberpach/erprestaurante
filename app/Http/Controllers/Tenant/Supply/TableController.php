...
class TableController extends Controller
{
    ...
    private TableManagement $s_table;

    public function __construct()
    {
        $this->s_table  =   new TableManagement();
    }

    public function index()
    {
        return view('supply.tables.index');
    }
...
*/
    public function update(TableUpdateRequest $request, int $id)
    {
        DB::beginTransaction();
        try {

            $table  =   $this->s_table->update($request->toArray(), $id);
